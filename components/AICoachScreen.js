                ...
                <div className={`flex items-center gap-2 mt-2 px-2 ${message.type === 'user' ? 'flex-row-reverse' : 'flex-row'}`}>
                  <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                    ...
                    {message.type === 'user' ? (
                      ...
                      <MaterialCommunityIcons name="robot" size={12} color="#4B5563" />
                    )}
                  </div>
        ...
        {messages.length === 1 && (
          <div className="px-6 mb-6">
            <div className="space-y-4">
              {/* AI Progress Scan - Enhanced with animation */}
              <button 
              ...
              >
                ...
                {/* Subtle glow around lightning bolt */}
              ...
              {/* Premium Features - Enhanced with benefit teasers */}
              ...
              <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 p-8 pt-12 text-white rounded-t-3xl">
                <div className="text-center">
                  <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4 backdrop-blur-sm">
                    <MaterialCommunityIcons name="crown" size={40} color="#fde047" />
                  </div>
